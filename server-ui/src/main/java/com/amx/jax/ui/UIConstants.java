...
public final class UIConstants extends Constants {
	...
	public enum Features {
		BENEFICIARY, PLACEORDER, RATE_ALERT, REMIT, FXORDER, EXCHANGE_RATE, TRANSACTION_HISTORY, ADD_BENEFICIARY,
		MY_INFORMATION, UP, DATE_SECURITY_QUESTION, UPDATE_SECURE_ACCESS_IMAGE, UPDATE_MOBILE_NUMBER,
		UPDATE_EMAIL_ADDRESS, SET_FINGERPRINT, EMPLOYMENT_DETAILS, RESET_PASSWORD, BENE_UPDATE;
