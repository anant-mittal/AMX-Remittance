...
public enum ResponseCodeBHR implements IPayGCode {
	//BANK of BENEFIT
	...
	PIN_EXCEED("38","Allowable PIN tries exceeded", "", CodeCategory.TXN_SUCCESS),
	RESTRICT_CARD("62","Restricted card", "", CodeCategory.TXN_SUCCESS),
	EXCEEDS_WITHDRAW_FREQUENCY_LIMIT("65","Exceeds withdrawal frequency limit", "", CodeCategory.TXN_SUCCESS),
	PIN_NUMBER_EXCEED("75","Allowable number PIN tries exceeded", "", CodeCategory.TXN_SUCCESS),
	INELIGIBLE_ACCOUNT("76","Ineligible account", "", CodeCategory.TXN_SUCCESS),
	REFER_ISSUE("78","Refer to Issuer", "", CodeCategory.TXN_SUCCESS),*/
