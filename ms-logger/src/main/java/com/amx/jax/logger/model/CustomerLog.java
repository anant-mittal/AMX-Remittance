...
public class CustomerLog extends LogMessage {
	...
	public CustomerLog(String appName, String customerId, String message, String productId, String searchTerm,
			String currentPage, String logType) {
	...
	public String toString() {
		return "CustomerLog{" + "customerId='" + customerId + '\'' + ", customerLogType=" + customerLogType
				+ ", productId='" + productId + '\'' + ", searchTerm='" + searchTerm + '\'' + ", currentPage='"
				+ currentPage + '\'' + "} " + super.toString();
	}
}
