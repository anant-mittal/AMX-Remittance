...
public class HomesendUtils
{
			...
			String wallet_service_provider, String beneficary_id, String remittance_mode)
	{
		if (remittance_mode.equalsIgnoreCase("07")) // Bank Account
		{
			...
			// beneficiary_account
			// + (Common_API_Utils.isEmpty(beneficiary_branch_code) == false ? ";bic=" +
			...
			else
			{
				...
				if (bic_indicator == SWIFT_CODE_IND && Common_API_Utils.isEmpty(beneficiary_bank_branch_swift_code) == false)
				{
					beneficiary_account = beneficiary_account.concat(";bic=" + beneficiary_bank_branch_swift_code);
				}
				else if (bic_indicator == BENEFICIARY_BANK_CODE_IND && Common_API_Utils.isEmpty(beneficiary_bank_code) == false)
				{
					beneficiary_account = beneficiary_account.concat(";bic=" + beneficiary_bank_code);
				}
				else if (bic_indicator == BENEFICIARY_BRANCH_CODE_IND && Common_API_Utils.isEmpty(beneficiary_branch_code) == false)
				{
			...
			String beneficiary_bank_code, String beneficiary_branch_code)
	{
		...
		if (Common_API_Utils.isEmpty(origin_country_3_digit_ISO) == false)
		...
		if (Common_API_Utils.isEmpty(service_type) == false)
			vsf_list.add(
					new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SERVICE_TYPE")), service_type));

		if (Common_API_Utils.isEmpty(destination_currency) == false)
			...
			Customer customer_data, Benificiary bene_data, String api_login)
	{
		...
		// Transaction Data
		if (Common_API_Utils.isEmpty(txn_data.getOrigin_country_3_digit_ISO()) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_SP_COUNTRY")),
					txn_data.getOrigin_country_3_digit_ISO()));
		if (Common_API_Utils.isEmpty(api_login) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
					new UnsignedInt(props.getString("SENDER_SERVICE_PROVIDER_NAME")), api_login));
		if (Common_API_Utils.isEmpty(form_service_type(customer_data.getCustomer_type(), bene_data.getBeneficiary_type())) == false)
		...
		if (Common_API_Utils.isEmpty(txn_data.getOut_going_transaction_reference()) == false)
		...
		if (Common_API_Utils.isEmpty(txn_data.getFurther_instruction()) == false)
			vsf_list.add(
		...
		if (Common_API_Utils.isEmpty(txn_data.getSource_of_fund_desc()) == false)
		...
		if (Common_API_Utils.isEmpty(txn_data.getTxn_collocation_type()) == false)
		...
		if (Common_API_Utils.isEmpty(txn_data.getPurpose_of_remittance()) == false)
		...
		if (Common_API_Utils.isEmpty("") == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
		...
		{
			if (Common_API_Utils.isEmpty(customer_data.getFull_name()) == false)
				vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_NAME")),
						customer_data.getFull_name()));
		}
		else
		{
			if (Common_API_Utils.isEmpty(customer_data.getFirst_name()) == false)
			...
			if (Common_API_Utils.isEmpty(customer_data.getMiddle_name()) == false)
			...
			if (Common_API_Utils.isEmpty(customer_data.getLast_name()) == false)
		...
		if (Common_API_Utils.isEmpty(customer_data.getNationality_3_digit_ISO()) == false)
		...
		if (Common_API_Utils.isEmpty(Common_API_Utils.dateToString(customer_data.getDate_of_birth(), "yyyy-MM-dd")) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_DATE_OF_BIRTH")),
					Common_API_Utils.dateToString(customer_data.getDate_of_birth(), "yyyy-MM-dd")));
		...
		if (Common_API_Utils.isEmpty(customer_data.getStreet()) == false)
		...
		if (Common_API_Utils.isEmpty(customer_data.getState()) == false)
		...
		if (Common_API_Utils.isEmpty(txn_data.getOrigin_country_3_digit_ISO()) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_ADDRESS_COUNTRY")),
					txn_data.getOrigin_country_3_digit_ISO()));
		if (Common_API_Utils.isEmpty(customer_data.getCustomer_reference()) == false)
		...
		if (Common_API_Utils.isEmpty(customer_data.getIdentity_type_desc()) == false)
		...
		if (Common_API_Utils.isEmpty(customer_data.getIdentity_no()) == false)
		...
		if (Common_API_Utils.isEmpty(Common_API_Utils.dateToString(customer_data.getIdentity_expiry_date(), "yyyy-MM-dd")) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_ID_EXPIRY_DATE")),
					Common_API_Utils.dateToString(customer_data.getIdentity_expiry_date(), "yyyy-MM-dd")));
		if (Common_API_Utils.isEmpty("") == false)
			vsf_list.add(
					new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("SENDER_PLACE_OF_BIRTH")), ""));
		if (Common_API_Utils.isEmpty(customer_data.getContact_no()) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
					new UnsignedInt(props.getString("SENDER_MOBILE_TELEPHONE_NUMBER")), customer_data.getContact_no()));
		if (Common_API_Utils.isEmpty(customer_data.getEmail()) == false)
		...
		if (Common_API_Utils.isEmpty(customer_data.getProfession()) == false)
		...
		{
			if (Common_API_Utils.isEmpty(bene_data.getFirst_name()) == false)
		...
		else
		{
			...
			if (Common_API_Utils.isEmpty(bene_data.getMiddle_name()) == false)
				vsf_list.add(new VendorSpecificField(VENDOR_ID,
						new UnsignedInt(props.getString("BENEFICIARY_MIDDLE_NAME")), bene_data.getMiddle_name()));
			if (Common_API_Utils.isEmpty(bene_data.getLast_name()) == false)
				vsf_list.add(new VendorSpecificField(VENDOR_ID,
		...
		if (
			bene_data.getBeneficiary_bank_branch_indicator() == SWIFT_CODE_IND
					&& Common_API_Utils.isEmpty(bene_data.getBeneficiary_bank_branch_swift_code()) == false)
			{
			...
			bene_data.getBeneficiary_bank_branch_indicator() == BENEFICIARY_BANK_CODE_IND
					&& Common_API_Utils.isEmpty(bene_data.getBeneficiary_bank_code()) == false)
			{
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("BENEFICIARY_BANK_CODE")),
			...
			bene_data.getBeneficiary_bank_branch_indicator() == BENEFICIARY_BRANCH_CODE_IND
					&& Common_API_Utils.isEmpty(bene_data.getBeneficiary_branch_code()) == false)
			{
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("BENEFICIARY_BANK_CODE")),
		...
		else if (bene_data.getBeneficiary_bank_branch_indicator() == BENEFICIARY_BRANCH_NAME_IND)
		{
			...
			if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_bank_name()) == false)
			{
				bank_branch_name = bene_data.getBeneficiary_bank_name();

				if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_branch_name()) == false)
				{
					bank_branch_name.concat(" - " + bene_data.getBeneficiary_branch_name());
				}
			}
			else if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_branch_name()) == false)
			{
				bank_branch_name = bene_data.getBeneficiary_branch_name();
			}

			if (Common_API_Utils.isEmpty(bank_branch_name) == false)
				vsf_list.add(new VendorSpecificField(VENDOR_ID,
		...
		if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_id_type()) == false)
		...
		if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_id_number()) == false)
		...
		if (Common_API_Utils.isEmpty("") == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("BENEFICIARY_EXPIRY_DATE")),
					""));
		if (Common_API_Utils.isEmpty(Common_API_Utils.dateToString(bene_data.getDate_of_birth(), "yyyy-MM-dd")) == false)
			vsf_list.add(
					new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("BENEFICIARY_DATE_OF_BIRTH")),
							Common_API_Utils.dateToString(bene_data.getDate_of_birth(), "yyyy-MM-dd")));
		if (Common_API_Utils.isEmpty("") == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
					new UnsignedInt(props.getString("BENEFICIARY_PLACE_OF_BIRTH")), ""));
		if (Common_API_Utils.isEmpty(bene_data.getProfession()) == false)
		...
		if (Common_API_Utils.isEmpty(bene_data.getFull_addrerss()) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
		...
		if (Common_API_Utils.isEmpty(Common_API_Utils.dateToString(bene_data.getDate_of_birth(), "yyyy-MM-dd")) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID, new UnsignedInt(props.getString("BENEFICIARY_BORN_DATE")),
					Common_API_Utils.dateToString(bene_data.getDate_of_birth(), "yyyy-MM-dd")));
		if (Common_API_Utils.isEmpty(bene_data.getBeneficiary_account_type()) == false)
			vsf_list.add(new VendorSpecificField(VENDOR_ID,
