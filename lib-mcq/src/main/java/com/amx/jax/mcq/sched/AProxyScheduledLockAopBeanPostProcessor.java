...
abstract class AProxyScheduledLockAopBeanPostProcessor extends AbstractBeanFactoryAwareAdvisingPostProcessor
		implements BeanPostProcessor, EmbeddedValueResolverAware, InitializingBean {
	private static final long serialVersionUID = 4798960236745477939L;
	...
	AProxyScheduledLockAopBeanPostProcessor(String defaultLockAtMostFor, String defaultLockAtLeastFor) {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) {
		// this code can not be in afterPropertiesSet() since resolver is not
		// initialized yet
