...
public class LockConfiguration {
	 ...
	 * (the process holding it has most likely died without releasing the lock) Can
	 * be ignored by providers which can detect dead processes (like Zookeeper)
	 */
	private final Instant lockAtMostUntil;
	/**
	 * The lock will be held until this time even if the task holding the lock
	 * finishes earlier.
	 */
