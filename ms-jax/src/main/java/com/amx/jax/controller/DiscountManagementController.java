...
public class DiscountManagementController implements IDiscManagementService {
	...
	public AmxApiResponse<CountryBranchDTO, Object> getCountryBranch(@RequestParam(value = "isActive", required = false, defaultValue = "false") Boolean isActive) {
		BigDecimal applicationCountryId = metaData.getCountryId();
		return discountManagementService.getCountryBranch(applicationCountryId,isActive);
	}
