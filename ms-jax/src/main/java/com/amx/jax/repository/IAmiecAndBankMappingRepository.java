...
public interface IAmiecAndBankMappingRepository  extends CrudRepository<AmiecAndBankMapping, Serializable>{
	...
	public AmiecAndBankMapping findByCountryIdAndBankIdAndFlexFieldAndAmiecCodeAndIsActive(CountryMaster countryId,BankMasterMdlv1 bankId,String flexField,String amiecCode,String isActive);
