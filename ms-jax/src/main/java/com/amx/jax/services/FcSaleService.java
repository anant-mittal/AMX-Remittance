...
public class FcSaleService extends AbstractService {
	...
	public ApiResponse getFCSaleLcAndFcAmount(BigDecimal applicationCountryId, BigDecimal countryBranchId,
	...
	public ApiResponse getDefaultFsSale(BigDecimal applicationCountryId, BigDecimal countryBranchId,
