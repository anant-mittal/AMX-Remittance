...
public class BranchRemittanceExchangeRateManager {
	...
	private BigDecimal getComission() {
		...
		logger.debug("routingBankId:"+routingBankId+ "rountingCountryId" +rountingCountryId+ "currencyId" +currencyId+ "remittanceMode" +remittanceMode+ "deliveryMode"+deliveryMode+"commission" +commission+ "newCommission" +newCommission);
