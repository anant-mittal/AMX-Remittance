...
public enum JaxError {
	...
	USER_NOT_REGISTERED, INVALID_JSON_BODY, INCORRECT_SECURITY_QUESTION_ANSWER, USER_LOGIN_ATTEMPT_EXCEEDED, EXCHANGE_RATE_NOT_FOUND,
	...
	INVALID_BENE_COUNTRY,INVALID_BENE_BANK,INVALID_BENE_BANK_CNTRY,RECORD_NOT_FOUND,NULL_CHECK,ACCOUNT_TYPE_UPDATE,INVALID_NATIONALITY,
    TRANSACTION_VALIDATION_FAIL,ACCOUNT_LENGTH,INVALID_MOB_TELE,UPDATE_BENE_NEEDED, NO_OF_TRANSACTION_LIMIT_EXCEEDED, 
    /* Maximum amount allowed for transaction*/TRANSACTION_MAX_ALLOWED_LIMIT_EXCEED,PG_ERROR, UNKNOWN_JAX_ERROR,
    MISSING_OTP,SEND_OTP_LIMIT_EXCEEDED,OTP_EXPIERED,TRANSACTION_HISTORY_NOT_FOUND,
    BENEFICIARY_LIST_NOT_FOUND,BENEFICIARY_COUNTRY_LIST_NOT_FOUND,NO_RECORD_FOUND;
