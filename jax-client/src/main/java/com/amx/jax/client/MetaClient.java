...
public class MetaClient extends AbstractJaxServiceClient implements IMetaControllerExtn {
	...
	public AmxApiResponse<WhyDoAskInformationDTO, Object> getWhyAskInfo() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_WHY).meta(new JaxMetaInfo())
	...
	public AmxApiResponse<UserFinancialYearDTO, Object> getFinancialYear() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_FYEAR).meta(new JaxMetaInfo())
	...
	public AmxApiResponse<CurrencyMasterDTO, Object> getBeneficiaryCurrency(BigDecimal beneficiaryCountryId,
		...
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(url)
				.queryParam("beneficiaryCountryId", beneficiaryCountryId).queryParam("serviceGroupId", serviceGroupId)
				.queryParam("routingBankId", routingBankId);
	...
	public AmxApiResponse<CurrencyMasterDTO, Object> getAllExchangeRateCurrencyList(Boolean isActive) {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.EXCHANGE_RATE_CURRENCY_LIST)
				.queryParam("isActive", isActive).meta(new JaxMetaInfo()).get()
				.as(new ParameterizedTypeReference<AmxApiResponse<CurrencyMasterDTO, Object>>() {
				});
	...
	public AmxApiResponse<CurrencyMasterDTO, Object> getCurrenciesByRoutingCountryId(BigDecimal countryId) {

		LOGGER.info("in Get Currencies for Routing Country");
		String url = this.getBaseUrl() + MetaApi.PREFIX + "/currency/byRoutingCountry/" + countryId;
		HttpEntity<Object> requestEntity = new HttpEntity<Object>(getHeader());
		return restService.ajax(url).get(requestEntity)
				.as(new ParameterizedTypeReference<AmxApiResponse<CurrencyMasterDTO, Object>>() {
				});
	...
	public AmxApiResponse<PrefixDTO, Object> getAllPrefix() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_PREFIX).meta(new JaxMetaInfo())
	...
	public AmxApiResponse<ViewAreaDto, Object> getAreaList() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_AREA_LIST)
				.meta(new JaxMetaInfo()).get()
	...
	public AmxApiResponse<ViewStatusDto, Object> getStatusList() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_STATUS_LIST)
				.meta(new JaxMetaInfo()).get()
	...
	public AmxApiResponse<CountryBranchDTO, Object> getCountryBranchList() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_COUNTRY_BRANCH_LIST)
				.meta(new JaxMetaInfo()).get()
	...
	public AmxApiResponse<ViewGovernateDto, Object> getGovernateList() {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_GOVERNATE_LIST)
				.meta(new JaxMetaInfo()).get()
	...
	public AmxApiResponse<ViewGovernateAreaDto, Object> getGovernateAreaList(BigDecimal governateId) {
		...
		return restService.ajax(appConfig.getJaxURL()).path(MetaApi.PREFIX + MetaApi.API_GOVERNATE_AREA_LIST)
				.meta(new JaxMetaInfo()).get().queryParam(MetaApi.PARAM_GOVERONATE_ID, governateId).get()
