...
-- add column in service group desc table

ALTER TABLE EX_SERVICE_GROUP_DESC 
ADD (SERVICE_GROUP_SHORT_DESC VARCHAR2(40) );

-- insert service group short desc
UPDATE "EX_SERVICE_GROUP_DESC" SET SERVICE_GROUP_SHORT_DESC = 'CASH' WHERE SERVICE_GROUP_DESC_ID=1;
UPDATE "EX_SERVICE_GROUP_DESC" SET SERVICE_GROUP_SHORT_DESC = 'BANK' WHERE SERVICE_GROUP_DESC_ID=2;
UPDATE "EX_SERVICE_GROUP_DESC" SET SERVICE_GROUP_SHORT_DESC = 'DD' SERVICE_GROUP_DESC_ID=3;
