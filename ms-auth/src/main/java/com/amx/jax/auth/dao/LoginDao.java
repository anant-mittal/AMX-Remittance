...
import com.amx.jax.auth.repository.IFunctionalityTypeRepository;
import com.amx.jax.auth.repository.ILoginRepository;
import com.amx.jax.auth.repository.IModuleRepository;
import com.amx.jax.auth.repository.IPermissionRepository;
import com.amx.jax.auth.repository.IPermissionScopeRepository;
import com.amx.jax.auth.repository.IRoleDefinitionRepository;
import com.amx.jax.auth.repository.IRoleMasterRepository;
import com.amx.jax.auth.repository.IUserMasterRepository;
...
public class LoginDao {
	...
	public Employee validateEmpDetails(String empcode,String identity) {
		return loginRepository.findByEmployeeNumberAndCivilId(empcode, identity);
	}
	...
	public PermissionMaster fetchPermissionMasterId(BigDecimal moduleId,BigDecimal functionalityTypeId,String functionality){
	...
	public RoleDefinition fetchRoleDefinitionByRolePermScope(BigDecimal roleId,BigDecimal permissionId,BigDecimal scopeId){
