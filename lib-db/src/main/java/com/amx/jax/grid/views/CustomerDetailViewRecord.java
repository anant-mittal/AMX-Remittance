...
public class CustomerDetailViewRecord implements GridViewRecord {
	 ...
	 * getHalfYearlyTransactionLimit() { return halfYearlyTransactionLimit; } public
	 * void setHalfYearlyTransactionLimit(BigDecimal halfYearlyTransactionLimit) {
	...
	/*
	 * @Column(name = "QY_TXN_LIMIT") public BigDecimal
	 * getQuaterlyTransactionLimit() { return quaterlyTransactionLimit; } public
	 * void setQuaterlyTransactionLimit(BigDecimal quaterlyTransactionLimit) {
