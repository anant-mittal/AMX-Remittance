...
import com.amx.jax.auditlogs.CountryListAuditEvent;
import com.amx.jax.auditlogs.JaxAuditEvent;
import com.amx.jax.utils.JaxContextUtil;

@Scope(value = WebApplicationContext.SCOPE_REQUEST, proxyMode = ScopedProxyMode.TARGET_CLASS)
@Component
public class CountryListAuditHandler extends AbstractAuditHanlder {
	...
	public JaxAuditEvent createAuditEvent() {
		...
		JaxAuditEvent event = new CountryListAuditEvent(model);		
		return event;
	}
}
