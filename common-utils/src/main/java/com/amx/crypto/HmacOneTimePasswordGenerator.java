...
public class HmacOneTimePasswordGenerator {
	 ...
	 * password length
	 * ({@value com.amx.crypto.eatthepath.otp.HmacOneTimePasswordGenerator#DEFAULT_PASSWORD_LENGTH}
	 * digits).
	 *
	 * @throws NoSuchAlgorithmException
	 *             if the underlying JRE doesn't support the
	 *             {@value com.amx.crypto.eatthepath.otp.HmacOneTimePasswordGenerator#HOTP_HMAC_ALGORITHM}
	 *             algorithm, which should never happen except in cases of serious
	 *             misconfiguration
	 */
