...
public class CommunicationChannelContactService {
	...
	public List<CustomerCommunicationChannel> getCustomerCommunicationChannels(String identityInt) {
		...
		return customerCommunicationChannels;
