...
@Component
public class OmanValidationClient implements ValidationClient {
	
	Logger logger = Logger.getLogger(OmanValidationClient.class);
	...
	public ValidationServiceCode getClientCode() {
		...
		return ValidationServiceCode.OMN;
	}
