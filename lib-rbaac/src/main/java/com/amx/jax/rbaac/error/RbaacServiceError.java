...
public enum RbaacServiceError implements IExceptionEnum {
	...
	// MISC
	UNKNOWN_EXCEPTION, CLIENT_ALREADY_REGISTERED, CLIENT_NOT_FOUND, BRANCH_SYSTEM_NOT_FOUND, 
	BRANCH_SYSTEM_NOT_ACTIVE, CLIENT_TOO_MANY_ACTIVE, CLIENT_NOT_ACTIVE, CLIENT_INVALID_PAIR_TOKEN, 
	CLIENT_INVALID_SESSION_TOKEN, CLIENT_ANOTHER_ALREADY_ACTIVE, CLIENT_NOT_LOGGGED_IN, 
	CLIENT_ALREADY_ACTIVE, CLIENT_EXPIRED_SESSION_TOKEN, CLIENT_EXPIRED_VALIDATE_OTP_TIME;
