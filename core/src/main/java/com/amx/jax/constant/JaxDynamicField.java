...
public enum JaxDynamicField {
	...
	BENE_BANK_IBAN_NUMBER, BENE_HOUSE_NO("BNFADDR3"), BENE_FLAT_NO("BNFADDR3"), BENE_STREET_NO("BNFADDR3"),AML_MESSAGE("AML_AUTH"),AML_REMARKS("AML_AUTH"),AML_USER_NAME("AML_AUTH"),AML_PASSWORD("AML_AUTH"),BENE_ZIP_CODE("BNFADDR3"),BENE_CITY_NAME("BNFADDR3");
