...
public enum JaxDynamicField {
	...
	AML_PASSWORD("AML_AUTH"),BENE_ZIP_CODE("BNFADDR3"),BENE_CITY_NAME("BNFADDR3"),BENEFICIARY_SWIFT_BANK1("BENEFICIARY_SWIFT_BANK"),BENEFICIARY_SWIFT_BANK2("BENEFICIARY_SWIFT_BANK");
