...
@Entity
@Table(name = "HIS_JAX_VW_EX_TRANSACTION_INQ")
public class CustomerRemittanceTransactionHistoryView implements Serializable {
	...
	public CustomerRemittanceTransactionHistoryView() {
	}

	public CustomerRemittanceTransactionHistoryView(BigDecimal idno, BigDecimal customerReference,
			BigDecimal documentNumber, String beneficaryAccountNumber, String beneficaryBankName,
			String beneficaryBranchName, String beneficaryName, String beneficaryCorespondingBankName,
			Date documentDate, BigDecimal documentFinanceYear, String foreignCurrencyCode,
			BigDecimal foreignTransactionAmount, String currencyQuoteName, String serviceDescription,
			String transactionStatusDesc, String transactionTypeDesc, BigDecimal collectionDocumentNo,
			BigDecimal collectionDocumentCode, BigDecimal collectionDocumentFinYear) {
		super();
		this.idno = idno;
