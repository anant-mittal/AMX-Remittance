...
public class ArticleDao {
	...
	public List<Map<String, Object>> getIncomeRange(BigDecimal countryId, BigDecimal articleDetailId) {
		...
		String sql = "SELECT FIRM.INCOME_RANGE_ID,FIRM.INCOME_FROM,FIRM.INCOME_TO,FIRM.ARTICLE_DETAIL_ID FROM FS_INCOME_RANGE_MASTER FIRM " + 
				" WHERE FIRM.APPLICATION_COUNTRY_ID = ? AND FIRM.ISACTIVE= ? AND FIRM.ARTICLE_DETAIL_ID = ? ";
