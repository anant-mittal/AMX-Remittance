...
public class PaymentController {
	...
	public String handleUrlPaymentRemit(@RequestParam String name,
										@RequestParam String country,
										@RequestParam String amount,
										@RequestParam String trckid,
										@RequestParam String pg,
										@RequestParam BigDecimal pgId,
										@RequestParam String docNo) {

		log.info("Inside handleUrlPaymentRemit with   name-"+name+", amount-"+amount+", country-"+country+", pg-"+pg+", pg_id-"+pgId);
		...
		log.info("KNET is initialted for doc number : "+trckid+"  and payid is : "+payid+"  and url formed is : "+payurl);
		return "redirect:"+payurl+"?paymentId=" + payid;
	}
	
	@RequestMapping(value={ "/payment_capture/*", "/payment_capture/" }, method = RequestMethod.POST,produces = {MediaType.APPLICATION_JSON_VALUE})
...
/*	@RequestMapping(value={ "/payment_capture/*", "/payment_capture/" }, method = RequestMethod.GET,produces = {MediaType.APPLICATION_JSON_VALUE})
	public String paymentCaptureGet(@RequestParam String PaymentID,HttpServletRequest request,Model model) {
	...
	@RequestMapping(value={ "/payment_capture/oman/*", "/payment_capture/oman" }, method = RequestMethod.POST,produces = {MediaType.APPLICATION_JSON_VALUE})
