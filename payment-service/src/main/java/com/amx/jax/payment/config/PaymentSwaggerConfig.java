...
public class PaymentSwaggerConfig {
	...
	public Docket productApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.amx.jax.payment"))
				.build().globalOperationParameters(globalParams);
	}

	@SuppressWarnings("unused")
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Payment Service Rest API", "Rest api", "1.0", "Terms of service",
