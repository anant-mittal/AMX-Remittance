...
public class UpdateCustomerAddressDetailRequest {
	...
	public String toString() {
		return "UpdateCustomerAddressDetailRequest [countryId=" + countryId + ", stateId=" + stateId + ", districtId=" + districtId + ", cityId="
				+ cityId + ", house=" + house + ", flat=" + flat + ", street=" + street + ", block=" + block + "]";
	}
