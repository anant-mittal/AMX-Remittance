...
public enum JaxError implements IExceptionEnum {
	...
	//signature pad
	CLIENT_NOT_FOUND, 
	CLIENT_NOT_ACTIVE, CLIENT_NOT_LOGGGED_IN, CLIENT_ALREADY_REGISTERED, CLIENT_INVALID_PAIR_TOKEN, CLIENT_INVALID_SESSION_TOKEN, CLIENT_ALREADY_ACTIVE, 
	CLIENT_EXPIRED_SESSION_TOKEN,
	/** FS Applcication **/
