...
public enum JaxError implements IExceptionEnum {
	...
	//signature pad
	DEVICE_NOT_FOUND, 
	DEVICE_NOT_ACTIVE, DEVICE_NOT_LOGGGED_IN, DEVICE_ALREADY_REGISTERED, DEVICE_INVALID_PAIR_TOKEN, DEVICE_INVALID_SESSION_TOKEN, DEVICE_ALREADY_ACTIVE,
	DEVICE_EXPIRED_SESSION_TOKEN;
