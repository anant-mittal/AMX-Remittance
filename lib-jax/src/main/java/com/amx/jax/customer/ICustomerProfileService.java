...
public interface ICustomerProfileService {
	...
	AmxApiResponse<CustomerContactVerificationDto, Object> createVerificationLink(BigDecimal customerId, ContactType type, String identity);
	...
	AmxApiResponse<CustomerContactVerificationDto, Object> verifyLinkByCode(String identity, BigDecimal linkId, String code);

	@ApiJaxStatus({ JaxError.ENTITY_INVALID, JaxError.ENTITY_EXPIRED, JaxError.INVALID_CIVIL_ID })
	AmxApiResponse<CustomerContactVerificationDto, Object> verifyLinkByContact(String identity, ContactType type, String contact);
