...
@Entity
@Table(name = "JAX_VW_CBK_REPORT")
public class jaxCbkReport implements Serializable {
	...
	private String trnxLocation;
	private String tranxMode;
	private Date accountMMYYY;
	private BigDecimal amountLocal;
	private String fundsCode;
	private String foreignCurrencyCode;
	private BigDecimal foreignAmount;
	private BigDecimal foreignExRate;
	...
	public String getTrnxLocation() {
		return trnxLocation;
	}

	public void setTrnxLocation(String trnxLocation) {
		this.trnxLocation = trnxLocation;
	}

	@Column(name = "TRANSMODE_CODE")
	public String getTranxMode() {
		return tranxMode;
	}

	public void setTranxMode(String tranxMode) {
		this.tranxMode = tranxMode;
	}

	@Column(name = "ACCOUNT_MMYYYY")
	public Date getAccountMMYYY() {
		return accountMMYYY;
	}

	public void setAccountMMYYY(Date accountMMYYY) {
	...
	public BigDecimal getForeignExRate() {
		return foreignExRate;
	}

	public void setForeignExRate(BigDecimal foreignExRate) {
