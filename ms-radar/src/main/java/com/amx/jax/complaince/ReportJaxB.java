...
public class ReportJaxB {
	...
	public void Marshilling(CBK_Report cbk) {
		...
		List<ParameterDetailsDto> actionDetailsDto=	complianceService.complainceActionData();
		List<ParameterDetailsDto> reasonDetailsDto=	complianceService.complainceReasonData();
