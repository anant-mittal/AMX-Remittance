...
public class ToForeignCurrency {
	...
	public ToForeignCurrency(String foreign_currency_code, String foreign_amount, String foreign_exchange_rate) {
		super();
		this.foreign_currency_code = foreign_currency_code;
		this.foreign_amount = foreign_amount;
		this.foreign_exchange_rate = foreign_exchange_rate;
	}
	public ToForeignCurrency() {
		super();
