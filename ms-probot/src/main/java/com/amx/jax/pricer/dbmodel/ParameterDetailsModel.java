...
public class ParameterDetailsModel implements Serializable {
	...
	public ParameterDetailsModel() {
		super();
	}

	public ParameterDetailsModel(BigDecimal parameterDetailsId, BigDecimal parameterMasterId, String recordId, String paramCodeDef, String fullDesc,
